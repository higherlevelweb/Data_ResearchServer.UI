...
import * as UIFileSaver from 'file-saver';
...
export class ExcelService {
  ...
  public exportAsExcelFileRealData(json: any[], excelFileName: string, plotNum: number): void {
  ...
  private saveAsExcelFile(buffer: any, fileName: string): void {
    ...
    UIFileSaver.saveAs(data, fileName + '_export_' + new Date().getTime() + EXCEL_EXTENSION);
  }


  private json_to_sheet(js/*:Array<any>*/, opts)/*:Worksheet*/ {
    var o = opts || {};
    var ws = ({}/*:any*/);
  ...
  generateExcel() {
    ...
    const title = 'Car Sell Report - test';
    ...
    let subTitleRow = worksheet.addRow(['Date : 2019-01-02']);
    // Add Image
